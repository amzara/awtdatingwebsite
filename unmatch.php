...
$query = "UPDATE users SET matching=0,currentmatch=0 WHERE user_name='$currentuser'";
mysqli_query($con, $query);
$query2= "UPDATE users SET matching=0,currentmatch=0 WHERE user_name='$matcheduser'";
